        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              At SpaDelhi.com, we believe true relaxation begins with a simple conversation.
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              ...
              and world-class wellness experiences. From the moment you contact Spa Delhi, you
              will experience personalized attention and expert guidance.
            </p>

            <p className="text-gray-300 leading-relaxed mb-6">
              Clients across Delhi NCR trust Spa Delhi for premium spa services delivered in 
      ...
      <section className="bg-black py-16">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-gray-400 leading-relaxed">
            Spa Delhi operates across premium locations in Delhi NCR, offering 
          ...
          <p className="mt-6 text-purple-400 font-semibold">
            ✨ Relax • Refresh • Rejuvenate with Spa Delhi ✨
          </p>
        </div>
      </section>
