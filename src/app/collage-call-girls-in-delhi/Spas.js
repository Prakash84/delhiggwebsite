      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-6">
          <h2 className="text-4xl lg:text-5xl font-extrabold leading-tight text-gray-900">
            College Call Girls <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500">in Delhi For</span> Men Who Love  
            <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-fuchsia-600"> Fresh Energy & Unfiltered Charm</span>
          </h2>

          <p className="mt-8 text-gray-600 max-w-xl">
            <span className="font-semibold text-purple-600"> </span>
            Delhi Girl is best escort agency allowing you to hire College call Girls in Delhi bringing a different kind of excitement. She looks soft, playful, curious, and quietly bold in a way that hits you the moment she walks in. The first impression of her sweet smile is innocent; however, a twinkle in her eyes makes your senses alert before she utters a single word. Her charm is a blend of heat and teasing confidence that creates tension effortlessly.
          </p>
          <p className="mt-8 text-gray-600 max-w-xl">
            College escorts lean close, brush your arm lightly, and laugh at the right moment. These small moves hit deeper than planned. They stay real, spontaneous, and tempting naturally, without ever feeling forced.
          </p>
          <p className="mt-8 text-gray-600 max-w-xl">
           
This is why Delhi college call girls feel so addictive. They carry a raw charm that older women cannot copy. They turn simple talks into moments filled with charge, warmth, and slow-growing attraction. A night with a college girl does not fade. It stays in your mind long after she steps out the door.
      ...
      <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        <div>
          <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 leading-snug">
            High Profile College <span className="text-pink-600">Call Girls in Delhi</span> at Low Price
          </h2>

          <p className="mt-6 text-gray-600 leading-relaxed">
           Why spend huge amounts on models who lack spark when you can enjoy high-profile college call girls at rates that actually suit your plan?
          </p>

          <p className="mt-4 text-gray-600 leading-relaxed">
            Our College call Girls in Delhi come from known universities in Delhi. They stay modern, neat, stylish, and full of strong confidence. Our College call Girls in Delhi provide the best class of companionship in 5-star hotels with a blend of innocence and playful heat which the clients love.
          </p>
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <div className="space-y-6 text-gray-600 text-base md:text-lg leading-relaxed">
            <p>
              If you want youthful, pretty, playful College call Girls in Delhi who can flip your mood with one smile and a hint of mischief, you are in the right place. We understand what you want because most clients search for the same thing. Fresh charm, bold confidence, and that hidden spark only college girls carry.
            </p>
            <p>
             At Delhi Girl, we offer the most popular college escort service in Delhi. Thousands of clients choose us for excitement, innocence, and the youthful vibe these girls bring. If loneliness stayed in your life for too long, it ends now. You reached the top college escort provider in Delhi, where every moment feels dreamy and alive.
            </p>
